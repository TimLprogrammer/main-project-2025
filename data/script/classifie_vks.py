...
def apply_keyword_rules(row):
    ...
    if 'cooler' in combined_text or 'koeler' in combined_text:
        return 'SF-VKS01', 1.0  # 100% confidence for keyword rule
    elif 'heating' in combined_text or 'verwarming' in combined_text:
...
def main(input_file=None):
    ...
    if all_vks_records.shape[0] > 0:
        ...
        # Confidence distribution - only for original SF-VKS records
        ...
        # Add extra statistics about the predictions
